...
export default async function AdminRepairsPage() {
  const [usersSnap, repairsSnap] = await Promise.all([
    adminDb.collection("users").get(),
    adminDb.collection("repairs").orderBy("createdAt", "desc").limit(50).get(),
  ]);
